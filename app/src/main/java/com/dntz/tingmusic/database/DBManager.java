package com.dntz.tingmusic.database;
...
import static com.dntz.tingmusic.database.DatabaseHelper.ID_COLUMN;
import static com.dntz.tingmusic.database.DatabaseHelper.MUSIC_ID_COLUMN;
        ...
        try {
            if (cursor != null) {
                ...
                while (cursor.moveToNext()) {
                   ...
                   // musicInfo.setAlbum(album);q                    musicInfo.setPath(path);
